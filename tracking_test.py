...
while True:
    ...
    frame = cv2.circle(frame, (320,320), 2, (0,255,255), 5)
    ...
    if int(elapsed_time) < 15:
        ...
        for i in range(len(result.boxes)):
            ...
            if not box_id == None:
                ...
                if name_class == "person" and box_id.item() == id_track:
                    ...
                    response = requests.post(url_control, data=data_post)
                    ...
                    # frame_ = cv2.line(frame_, point_center, point_center_dt, (255,255,0), 5)
        ...
        for box in boxes_:
            ...
            # cv2.circle(frame_, (int(predicted_state[0]), int(predicted_state[1])), 4, (0, 255, 255), -1)
